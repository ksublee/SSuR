...
Then X+Y ~ N(mu1 + mu2, sigma1^2 + sigma2^2)
...
```
    ...
    ## When rho is  -0.7  the variance of X+Y is : 0.6202883 
    ## When rho is  0  the variance of X+Y is : 2.069887 
    ## When rho is  0.7  the variance of X+Y is : 3.517117
...
![](10.Continuous_random_variable_files/figure-markdown_github/unnamed-chunk-22-1.png) \#\#\# t statistics
...
-   Let X be the time of decay of a single atom, then X ~ exp(lambda) and
...
-   After t years there are t power stations operating, so the total rate of accident is alpha\*t^2.
    -   m lambda t^(m-1) = alpha t^2 =&gt; m=3, lambda=alpha/3
...
-   Merging
    -   If we merge a Poisson process rate lambda1 with an independent Poisson process lambda2, then the results is a Poisson process rate lambda1 + lambda2.
...
![](10.Continuous_random_variable_files/figure-markdown_github/unnamed-chunk-42-1.png)
...
![](10.Continuous_random_variable_files/figure-markdown_github/unnamed-chunk-43-1.png)
...
![](10.Continuous_random_variable_files/figure-markdown_github/unnamed-chunk-46-1.png)
...
![](10.Continuous_random_variable_files/figure-markdown_github/unnamed-chunk-47-1.png)
