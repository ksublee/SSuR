...
```
    ...
    ## When rho is  -0.7  the variance of X+Y is : 0.5846163 
    ## When rho is  0  the variance of X+Y is : 1.916945 
    ## When rho is  0.7  the variance of X+Y is : 3.256487
...
-   After t years there are t power stations operating, so the total rate of accident is alpha\*t^2.
    -   m lambda t^(m-1) = alpha t^2 =&gt; m=3, lambda=3
