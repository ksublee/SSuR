...
```
    ...
    ## When rho is  -0.7  the variance of X+Y is : 0.5813586 
    ## When rho is  0  the variance of X+Y is : 1.889436 
    ## When rho is  0.7  the variance of X+Y is : 3.195518
...
-   After *t* years there are *t* power stations operating, so the total rate of accident is *α**t*<sup>2</sup>.
    -   m*λ* *t*<sup>(*m* − 1)</sup> = *α* *t*<sup>2</sup> =&gt; m=3, *λ* = *α*/3
