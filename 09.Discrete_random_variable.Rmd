...
We use notation $B \sim Bernoulli(p)$.
...
* We write $Y \sim $ geom$(p)$, and we have,
...
We say $X$ has a Poisson distribution with parameter $\lambda$,a nd write $X \sim pois(\lambda)$.
