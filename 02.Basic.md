...
![](02.Basic_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-10-1.png)
...
-   logical\_expression is evaluated first.
-   If it is TRUE, then the expression in { } is executed.
-   back to the start of the command.
-   If logical\_expression is FALSE, the loop stop.
