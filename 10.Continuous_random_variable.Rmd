...
$X \sim N(\mu_1, \sigam_1^2), Y ~ N(\mu_2, \sigma_2^2)$
...
* If $\lambda(x) = \lambda$, constant rate of failure, then we say $X$ has an exponential distribution and write $X \sim \exp (\lambda)$.
